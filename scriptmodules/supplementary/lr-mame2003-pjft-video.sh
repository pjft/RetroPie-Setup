...
rp_module_id="lr-mame2003-pjft-video"
...
function sources_lr-mame2003-pjft-video() {
    gitPullOrClone "$md_build" https://github.com/pjft/mame2003-libretro.git pjft-video-fix
}

function build_lr-mame2003-pjft-video() {
    rpSwap on 750
    make clean
    local params=()
...
function install_lr-mame2003-pjft-video() {
    md_ret_files=(
...
function configure_lr-mame2003-pjft-video() {
    local mame_dir
    local mame_sub_dir
