...
function sources_lr-mame2003-pjft() {
    gitPullOrClone "$md_build" https://github.com/pjft/mame2003-libretro.git pjft-experimental
}

function build_lr-mame2003-pjft() {
    rpSwap on 750
    make clean
    local params=()
...
function install_lr-mame2003-pjft() {
    md_ret_files=(
...
function configure_lr-mame2003-pjft() {
    local mame_dir
    local mame_sub_dir
